class Ingredient < ApplicationRecord
  ...
  validates :carbs, :total_fats, :saturated_fats, :protein, :salt, numericality: { only_integer: true, less_than_or_equal_to: 100, message: 'Please enter a decimal number up to 100.' }
